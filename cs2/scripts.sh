...
curl 40.64.87.197:6001/metrics
curl 40.64.87.197:6001/echo -d '{"Input":"TestInput"}'
curl 40.64.87.197:5001/inference -d '{"Input":"TestInput"}'

xargs -I %\n -P 100 curl 40.64.87.197:6001/metrics < <(printf '%s\n' {1..10000000})