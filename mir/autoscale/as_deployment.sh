...
az group create -n $resourcegroup --tags owner=suriyak@microsoft.com SkipAutoDeleteTill=2022-09-01
...
az ml online-deployment create -e $epname -n $depname -f as_dep.yml --all-traffic
